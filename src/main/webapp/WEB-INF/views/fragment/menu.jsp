<header class="main-header">
	...
	<a href="../../index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>S</b>AS</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>Sport</b>AggregationSystem</span>
	</a>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="resources/dist/img/profile.png" class="user-image"
						alt="User Image"> <span class="hidden-xs">${cookie.firstName.value}
							${cookie.lastName.value}</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img
							src="resources/dist/img/profile.png" class="img-circle"
							alt="User Image">

							<p>
								${cookie.firstName.value} ${cookie.lastName.value} - Web
								Developer <small>Member since Nov. 2012</small>
							</p></li>
						<!-- Menu Body -->
						<li class="user-body">
							<div class="row">
	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="resources/dist/img/profile.png" class="img-circle"
					alt="User Image">
			</div>
			<div class="pull-left info">
				<p>${cookie.firstName.value}${cookie.lastName.value}</p>
		...
		<ul class="sidebar-menu">
			...
			<li id="sportsTree" class="treeview"><a href="#"> <i
					class="fa fa-table"></i> <span>Sport</span> <i
					class="fa fa-angle-left pull-right"></i>
			</a>
				<ul class="treeview-menu">
					<li id="sports"><a href="sports"><i class="fa fa-circle-o"></i>Sports</a></li>
					<li id="sportsCategory"><a href="sportCategories"><i
							class="fa fa-circle-o"></i>Sport Categories</a></li>
				</ul></li>
			<li id="placesTree" class="treeview"><a href="#"> <i
					class="fa fa-map-marker"></i> <span>Places</span> <i
					class="fa fa-angle-left pull-right"></i>
			</a>
				<ul class="treeview-menu">
					<li id="places"><a href="places"><i class="fa fa-circle-o"></i>
							Places</a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-user"></i>
					<span>Users</span> <span class="label label-primary pull-right">4</span>
			</a>
				<ul class="treeview-menu">
			...
			<li class="treeview"><a href="#"> <i
					class="fa fa-flag-checkered"></i> <span>Competitions</span> <i
					class="fa fa-angle-left pull-right"></i>
			</a>
				<ul class="treeview-menu">
			...
			<li><a href="../../documentation/index.html"><i
					class="fa fa-book"></i> <span>Info</span></a></li>
		</ul>
	</section>
	<!-- /.sidebar -->
</aside>
